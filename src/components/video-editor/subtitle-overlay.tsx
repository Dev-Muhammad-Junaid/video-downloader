...
export function SubtitleOverlay({
    ...
    switch (stylePreset) {
        ...
        case "tiktok": {
            ...
            // For preview, highlight a fixed word; for real playback, use time-based highlight
            const highlightIdx = currentSubtitle
                ? getHighlightedWordIndex(currentSubtitle, currentTime)
                : 1; // Highlight 2nd word in preview
            return (
                    ...
                    <div className="text-center max-w-[80%]">
                        <span
                            ...
                            style={{
                                ...
                                paintOrder: "stroke fill",
                                textShadow:
                                    "0 0 20px rgba(255,255,255,0.15), 0 4px 12px rgba(0,0,0,0.8)",
                            }}
                        >
                            {displayText}
                        </span>
